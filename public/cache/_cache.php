...
<meta name="keywords" content="<?= $wallpaper->meta_keywords; ?>">
<meta name="description" content="<?= $wallpaper->meta_description; ?>">
...
<body class="bg-white font-sans">
  <header class="bg-green-100 p-4 flex items-center justify-between md:px-20" style="position:fixed;z-index:10;top:0;left:0;width:100%;">
    <div class="flex items-center">
      <!-- <a href="http://localhost/vibewalls_v2/index">
        <img src="<?= URL_ROOT; ?>assets/images/logo-1.png" alt="Firstcare Financial Services Logo" class="object-cover w-auto md:h-[30px] h-6">
      </a> -->
      <h1 class="ml-2 text-xl font-semibold montserrat"><a href="http://localhost/vibewalls_v2/index">Vibewalls</a></h1>
    </div>
    <nav class="space-x-4 hidden md:flex md:gap-3 montserrat text-sm">
      <a href="http://localhost/vibewalls_v2/wallpapers/list" class="hover:text-green-500">Wallpapers</a>
      <!--
...
<section class="py-16 mx-auto px-5 md:px-20 md:py-20 mt-10 md:mb-10">
    <!-- Heading -->
    ...
    <div class="md:flex justify-center gap-10">
      ...
      <div class="w-full md:w-2/3 mb-10 md:mb-0">
        <h2 class="montserrat text-3xl font-bold text-gray-900 mb-5"><?= $wallpaper->image_name; ?></h2>
        <div class="group relative rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-shadow">
          <img 
            ...
            class="w-full h-98 object-cover group-hover:scale-105 transition-transform duration-300"
          />
        ...
        <div class="mt-3">
          <!-- <h3 class="font-semibold text-gray-900 mb-5">Mobile Wallpapers</h3> -->
          <p class="text-gray-500"><?= $wallpaper->description; ?></p>
        </div>
      </div>


      <div class="w-full md:w-1/3 mb-10 md:mb-0 montserrat">
        <div class="flex gap-5">
            <div class="w-1/2 p-5 text-center bg-green-100 rounded-lg">
                <h3 class="font-bold text-2xl">20</h3>
                <p class="font-semibold text-lg">Views</p>
            </div>
            <div class="w-1/2 p-5 text-center bg-green-100 rounded-lg">
                <h3 class="font-bold text-2xl">13</h3>
                <p class="font-semibold text-lg">Downloads</p>
            </div>
        </div>
        <div class="mt-10">
            <a download href="<?= $wallpaper->image_link; ?>" class="bg-green-600 text-white font-semibold py-3 px-6 rounded-md hover:bg-green-500 text-sm flex justify-center gap-3">
                <span>Download Wallpaper</span>
            </a>
        </div>
        <div class="mt-10 p-5 bg-green-100 rounded-lg">
            <h3 class="font-bold text-lg mb-5">Categories</h3>
      ...
      <div class="flex justify-center gap-10 mt-5 md:mt-1 montserrat">
        <div class="">
          ...
          <ul class="text-sm space-y-2">
            <li><a href="http://localhost/vibewalls_v2/index">Home</a></li>
            <li><a href="http://localhost/vibewalls_v2/wallpapers/list">Wallpapers</a></li>
            <!--
...
<div id="drawer-navigation" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-64 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
  ...
  <div class="py-4 overflow-y-auto">
      <ul class="space-y-2 font-medium">
        <li>
            <a href="http://localhost/vibewalls_v2/index" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <span class="flex-1 ms-3 whitespace-nowrap">Home</span>
            </a>
         </li>
         <li>
            <a href="http://localhost/vibewalls_v2/wallpapers/list" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
